...
@section('body')
    <section class="flex items-center justify-center -mb-1"
        ...
        <div class="items-center max-w-6xl grid-cols-2 gap-10 py-32 mx-auto px-14 mb-18 md:mb-52 md:grid lg:flex md:gap-14">
            ...
            <ul class="flex-1 p-5 pl-8 mt-8 text-2xl text-gray-700 list-disc md:mt-10">
                <li>Growth</li>
    ...
    <section class="text-center text-white bg-brown-dark">
    ...
    <section class="py-10 text-center text-white mb-14 bg-green">
        <div class="container">
            <div class="">
                ...
                <img class="w-full max-w-xl mx-auto mt-10 rounded-lg shadow-xl" src="assets/images/student-studying.jpg"
                    alt="teacher working with student">
            </div>
        </div>
    </section>

    <section class="block curriculum">
        <div class="container">
            <div class="section">
                <h2>Curriculum</h2>
            </div>
        ...
        <div class="container">
            ...
            <div x-show="open">
                <x-testimony name="STARS" name="Rydell Payne" title="from STARS">
                    <img class="w-full max-w-lg mx-auto" src="assets/images/stars-logo.png" alt="STARS logo">
                    <p>
                ...
                <x-testimony>
                    <div class="grid max-w-lg gap-5 mx-auto mb-5 md:max-w-none md:grid-cols-2">
                        <div class="w-2/3 md:w-full">
                            <img class="rounded-lg shadow-xl" src="assets/images/card-01-front.jpg"
                                alt="front of the card from Nancy">
                        </div>
                        <div class="relative w-2/3 ml-auto -top-28 md:top-0 md:w-full md:mx-auto -mb-28 md:mb-0">
    ...
    <section class="py-10 my-10">
        <div class="container">
            <div class="gap-10 md:grid md:grid-cols-4">
                <div class="md:mt-5">
                    <img class="w-1/2 mx-auto rounded-lg shadow-xl md:w-full md:ml-0" src="assets/images/dolores-carr.jpg"
                        alt="Dr. Dolores Carr">
                </div>
